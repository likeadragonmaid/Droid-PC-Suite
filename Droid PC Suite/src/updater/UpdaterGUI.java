...
public class UpdaterGUI extends JFrame {
	...
	public UpdaterGUI() {
		try {
			...
			URL url2 = new URL("https://raw.githubusercontent.com/gibcheesepuffs/Droid-PC-Suite/master/.release-changelog.txt");
		...
		btnDownload.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (userSelection == JFileChooser.APPROVE_OPTION) {
					...
					try {
						URL url = new URL("https://github.com/gibcheesepuffs/Droid-PC-Suite/releases/download/"
