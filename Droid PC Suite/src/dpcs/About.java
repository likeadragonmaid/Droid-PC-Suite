	...
	public About() {
		...
		btnGitHub.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					Desktop.getDesktop().browse(new URL("https://github.com/gibcheesepuffs/Droid-PC-Suite/").toURI());
		...
		JLabel lblApplicationVersion = new JLabel("Version: " + AppVersion + " OFFICIAL");
